...
def parse_args():
    ...
    model_g.add_arg("model_load_path", str, "./gru_noacc_model", "model path")
    model_g.add_arg("model_save_path", str, "./gru_noacc_quant_model", "model path")
...
def do_quant(args):
    ...
    generator = dataset.infer_reader(args.test_data, place)
